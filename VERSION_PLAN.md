...
- package.json / package-lock.json: `2.0.0-rc.1`
- 当前本地版本标签：`v2.0.0-rc.1`（2026-09-03）
- RC 后续修复记录在 CHANGELOG 的“未发布”部分，发布前需重新验证和打包。
...
#### 短期（当前开发阶段）
1. **v2.0.0-rc.1** - 第一个候选版本（仓库版本、标签与本地安装包已生成）
   - 桌宠闪烁修复 ✅
   - CI 修复 ✅
   - 测试修复 ✅
   - 暗色模式 ✅
...
- [x] v2.0.0-rc.1 - 第一个候选版本，已建立本地标签与打包产物
- [ ] v2.0.0-rc.2/rc.3... - 根据真实使用测试反馈迭代
- [ ] v2.0.0（TBD）- 正式版发布
