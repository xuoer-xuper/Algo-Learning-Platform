...
function getVjudgePageProblem(url: string): { problemId?: string; contestId?: string; problemIndex?: string } | null {
...
function statusCellsMatchPageProblem(raw: SubmissionDetectionPayload, cells: string[], parsedProblem: ReturnType<typeof parseVjudgeProblemText>): boolean {
...
function parseVjudgeProblemFromResult(result: Record<string, unknown> | null): ReturnType<typeof parseVjudgeProblemText> {
...
function parseVjudgeSolutionData(raw: SubmissionDetectionPayload): SubmissionData | null {
