...
function createApiMock(): ElectronAPI {
  ...
  return {
    ...
    getRemoteUserScriptInstallPreview: async () => null,
    confirmRemoteUserScriptInstall: async () => null,
    cancelRemoteUserScriptInstall: async () => true,
    getCredentialAutofillPrompt: async () => null,
    respondCredentialAutofill: async () => true,
    onCredentialAutofillPrompt: () => () => {},
    getCredentialCapturePrompt: async () => null,
    respondCredentialCapture: async () => true,
    onCredentialCapturePrompt: () => () => {},
    onCredentialCaptureResult: () => () => {},
