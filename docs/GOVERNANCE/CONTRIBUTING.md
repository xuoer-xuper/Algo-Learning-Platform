...
- [SYSTEM_ARCHITECTURE.md](../DESIGN/SYSTEM_ARCHITECTURE.md)：进程、模块、IPC、浏览器和数据流边界。
- [DATABASE_SCHEMA.md](../DESIGN/DATABASE_SCHEMA.md)：SQLite schema、migration 和数据约束。
- [SITE_ADAPTER_GUIDE.md](../DESIGN/SITE_ADAPTER_GUIDE.md)：站点适配、提交监测和 parser 规范。
- [SECURITY.md](SECURITY.md)：安全与隐私报告边界。
- [COMMIT_RULES.md](COMMIT_RULES.md)：提交信息约定。

涉及提交监测、实时 hook 或 OJ adapter 时，还必须阅读 [SUBMISSION_MONITORING_DESIGN.md](../DESIGN/SUBMISSION_MONITORING_DESIGN.md)。
...
- 数据库 schema 变化必须新增 migration，并同步 [DATABASE_SCHEMA.md](../DESIGN/DATABASE_SCHEMA.md) 和 [DATABASE_MIGRATION_ROLLBACK.md](../OPERATIONS/DATABASE_MIGRATION_ROLLBACK.md)。
